...
public:
  ...
  std::string mangleStruct(std::span<const ast::VisItem *> path,
                           ast::Crate *crate);
...
private:
  ...
  tryBasicType(const ast::types::TypePathSegment &) const;
  ...
  std::string mangleIdentifier(const adt::Identifier &) const;
};
