...
\code{hlfir\_MatmulTransposeOp} https://reviews.llvm.org/D145957
...
Pratt parser~\cite{pratt1973top}

SLP~\cite{chen2022all}

Nesting of reducible and irreducible loops~\cite{havlak1997nesting}
